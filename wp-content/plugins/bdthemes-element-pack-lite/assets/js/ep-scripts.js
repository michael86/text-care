        ...
        MegaMenu = ModuleHandler.extend({
            ...
            run: function () {
               ...
               var dropMenu =  $($container).find('.ep-megamenu-vertical-dropdown');
                ...
                //dropdown options
                options.flip = false;
                options.offset = (this.settings("offset.size") !== undefined) ? this.settings('offset.size') : '10';
                ...
                // bdtUIkit.toggle($toggler, {
                //     target: '#ep-megamenu-' + widgetID + '-virtual',
                ...
                $elementor_section.find('.ep-virtual-area .ep-menu-nav-link').addClass('bdt-accordion-title');
                ...
                // var virtualElement = $('#ep-megamenu-' + widgetID + '-virtual');
                // $(virtualElement).attr('hidden', true);
                ...
                // bdtUIkit.drop($($toggleContent), 'beforehide', function(){
                //     console.log('first');
                // });
